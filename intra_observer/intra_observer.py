...
def main(file_first: str, file_last: str) -> None:
    ...
    ----------
    file_first : str
        Path to the first calibration Excel file.
    file_last : str
        Path to the last calibration Excel file.
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="İntra-observer tutarlılık analizi")
    parser.add_argument("file_first", help="Birinci kalibrasyon Excel dosyasının yolu")
    parser.add_argument("file_last", help="Son kalibrasyon Excel dosyasının yolu")
