...
coco_json_path = 'local/labels_my-project-name_2024-06-07-05-39-53.json'  # COCO JSON dosyanızın yolu

with open(coco_json_path, 'r') as json_file:
    coco_data = json.load(json_file)

# İlgili görsel için bilgileri seçin (örneğin, image_id'yi belirtin)
target_image_id = 32  # İlgili görselin image_id'si
...
if target_image_data:
    ...
    masks_folder_path = 'local/masks_deneme1'
