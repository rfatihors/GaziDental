...
| Model vs expert mean, ICC(2,1) mm | 0.868 | [0.819, 0.904] | 145 |
| … bias (model − expert mean), mm | +0.16 | [+0.03, +0.28] | 145 |
| Model vs clinical reference, ICC(2,1) mm | 0.868 | [0.819, 0.904] | 145 |
| … bias (model − clinical reference), mm | +0.15 | [+0.03, +0.27] | 145 |
