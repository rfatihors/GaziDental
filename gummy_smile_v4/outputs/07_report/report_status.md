...
| Figure: segmentation examples GT vs prediction (Reviewer 1) | pending | outputs/05_predictions/oof or test masks |  | outputs/07_report/figures/segmentation_examples.png |
...
| Figure: measurement vs clinical reference, predicted masks (OOF) | pending | Stage 6 outputs |  | outputs/07_report/figures/measurement_predicted_masks.png |
| Figure: learning curve (Reviewers 2 & 4, Supplementary S1) | pending | outputs/05_predictions/learning_curve.png (workstation) |  | outputs/07_report/figures/learning_curve.png |
| Figure: boundary error, upper/lower gingiva edge (Reviewer 2 #10) | pending | outputs/05_predictions/boundary_error.csv |  | outputs/07_report/figures/boundary_error.png |
...
| Table: Segmentation metrics on the fixed test set (per class) | pending | outputs/05_predictions/test_metrics.json (evaluate_test on the workstation) |  | outputs/07_report/tables/segmentation_metrics_test.md |
| Table: Learning curve points (Supplementary S1) | pending | outputs/05_predictions/learning_curve.csv with all four points trained (learning_curve --collect on the workstation) |  | outputs/07_report/tables/learning_curve.md |
