...
| Figure: learning curve (Reviewers 2 & 4, Supplementary S1) | pending | outputs/09_final_rfdetr/learning_curve.png (scripts/build_rfdetr_learning_curve.py on the workstation metrics) |  | outputs/07_report/figures/learning_curve.png |
