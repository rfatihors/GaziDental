...
| analysis | n | px_per_mm | mae_mm | rmse_mm | r | icc2_1 | icc2_1_ci_low | icc2_1_ci_high | bias_mm | loa_low_mm | loa_high_mm | correction | kappa_linear | n_clipped |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
...
| Predicted masks (OOF, fold models), all reference images, C_p25 — corrected, offset_px (secondary) | 144 | 16.840 | 0.494 | 0.733 | 0.875 | 0.871 | 0.825 | 0.906 | -0.088 | -1.518 | 1.343 | offset_px -13 (-0.77 mm at 16.84 px/mm), secondary | 0.743 | 0.000 |
...
| Predicted masks (OOF), Stage-3 holdout images, C_p25 — corrected | 57 | 16.840 | 0.461 | 0.635 | 0.894 | 0.891 | 0.823 | 0.934 | -0.102 | -1.340 | 1.137 | offset_px -13 (-0.77 mm at 16.84 px/mm), secondary | 0.794 | 0.000 |
...
| Predicted masks (final model), test-set high images, C_p25 — corrected | 29 | 16.840 | 0.491 | 0.908 | 0.804 | 0.801 | 0.621 | 0.901 | -0.125 | -1.919 | 1.668 | offset_px -13 (-0.77 mm at 16.84 px/mm), secondary | 0.640 | 0.000 |
