...
| analysis | n | px_per_mm | mae_mm | rmse_mm | r | icc2_1 | icc2_1_ci_low | icc2_1_ci_high | bias_mm | loa_low_mm | loa_high_mm |
|---|---|---|---|---|---|---|---|---|---|---|---|
...
| Predicted masks (OOF, 145 images) — PENDING: Stage 6 (workstation masks) | 0 |  |  |  |  |  |  |  |  |  |  |

- source: outputs/03_oracle
- selected_method: C_p25
- prediction_rows: pending
