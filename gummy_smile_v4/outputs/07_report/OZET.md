...
- `scripts/build_report.py` mevcut verilerle 7 öge üretti, 7 öge bekliyor (`report_status.md`: ne gerektiği yazıyor). Veri gelince aynı komut yeniden çalıştırılır.
