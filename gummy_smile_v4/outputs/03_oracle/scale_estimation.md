...
Global scale: regression through the origin on the **dev subset only** (n = 87): **16.84 px/mm** (R² 0.716; residual SD 0.77 mm). Applied unchanged to holdout.
Leave-one-out on dev: mean 16.84, SD 0.069, range 16.71–17.32 px/mm; LOO MAE 0.566 mm.
...
overall: mean 18.88, SD 6.31, CV 0.33, median 18.15.
