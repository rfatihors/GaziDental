...
For information only, never used: a through-origin fit of the same method on the dev subset of *these* masks would give 17.21 px/mm (+2.2 %); leave-one-out on that fit: mean 17.21, SD 0.071, range 17.07–17.71 px/mm.
...
| 2698x1799 ±2 px | 123 | 19.538 | 4.433 | 19.086 | 0.227 |
