...
- **Birincil (a) — 145 ölçümlü high, OOF maske (ölçülen n = 145):** MAE 0.52 mm, RMSE 0.73, r 0.892, ICC(2,1) 0.877 [0.805, 0.919]; sapma +0.27 mm, LoA -1.07…1.60; sınıf uyumu 76 %, doğrusal ağırlıklı κ 0.72 [0.63, 0.80].
  - Aynı yöntem GT maskede (Aşama 3): MAE 0.55, sapma +0.15 → segmentasyonun eklediği: MAE -0.02 mm, sapma +0.12 mm (alt dişeti kenarı GT'den 0.07 mm aşağıda çiziliyor; üst kenar +0.02 mm).
...
- **Segmentasyon kalitesi:** (a) dişeti IoU 0.821, üst kenar MAE 0.28 mm, alt kenar MAE 0.47 mm (sapma +0.07), dudak IoU 0.836; (b) IoU 0.820; (c) tüm test 29 görüntü IoU 0.820 — low nan, normal nan. Low/normal'da düşük IoU beklenen bir durum: dişeti ince ya da görünmüyor (low'da GT dişeti genişliği medyan nan sütun, high'da 935); kenar hataları high'dan büyük değil. Birincil sonuç (a) üzerinden verilir.
