...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| (a) OOF, 145 reference high | RF-DETR-Seg Large @624, seed 42, 5 fold models | 145 | 145 | 145 | 0 | 0 | 0 | 145 | 0.821 | 0.838 | 0.395 | 0.277 | 0.240 | 0.016 | 0.466 | 0.436 | 0.076 | 0.541 | 0.039 | 0.009 | 935.000 | 0.836 | 0.856 |
| (b) test high, final model | RF-DETR-Seg Large @624, seed 42 | 29 | 29 | 29 | 0 | 0 | 0 | 29 | 0.821 | 0.834 | 0.368 | 0.255 | 0.224 | 0.021 | 0.482 | 0.474 | 0.036 | 0.576 | 0.045 | 0.006 | 941.000 | 0.834 | 0.856 |
| (b') test high, OOF masks | RF-DETR-Seg Large @624, seed 42, 5 fold models | 29 | 29 | 29 | 0 | 0 | 0 | 29 | 0.832 | 0.847 | 0.400 | 0.246 | 0.213 | -0.009 | 0.447 | 0.442 | 0.051 | 0.533 | 0.033 | 0.009 | 941.000 | 0.849 | 0.857 |
| (c) test all | RF-DETR-Seg Large @624, seed 42 | 29 | 29 | 29 | 0 | 0 | 0 | 29 | 0.821 | 0.834 | 0.368 | 0.255 | 0.224 | 0.021 | 0.482 | 0.474 | 0.036 | 0.576 | 0.045 | 0.006 | 941.000 | 0.834 | 0.856 |
...
| [reference] YOLOv11x (previous final model), OOF 145 reference high | YOLOv11x (previous final model) | 145 | 145 | 144 | 1 | 0 | 0 | 145 | 0.758 | 0.774 | 0.270 | 0.322 | 0.255 | 0.160 | 0.763 | 0.729 | 0.661 | 0.724 | 0.042 | 0.015 | 935.000 | 0.794 | 0.814 |
...
|---|---|---|---|---|---|---|---|
| (a) OOF, 145 reference high | RF-DETR-Seg Large @624, seed 42, 5 fold models | 4.67 | 4.05 | 0.28 | 7.86 | 1.27 | 9.11 |
| (b) test high, final model | RF-DETR-Seg Large @624, seed 42 | 4.30 | 3.77 | 0.36 | 8.12 | 0.61 | 9.70 |
| (b') test high, OOF masks | RF-DETR-Seg Large @624, seed 42, 5 fold models | 4.14 | 3.59 | -0.16 | 7.53 | 0.86 | 8.97 |
| (c) test all | RF-DETR-Seg Large @624, seed 42 | 4.30 | 3.77 | 0.36 | 8.12 | 0.61 | 9.70 |
