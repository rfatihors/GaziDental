...
* (c) regression: reference ≈ a + b · pipeline on dev → **a = -0.778 mm, b = 1.024**; corrected value = a + b · pipeline. The slope is a +2.4 % proportional term: it is **not** 1, and (a) and (b), which shift without scaling, leave it in place.
