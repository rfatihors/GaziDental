...
- **Birincil (a) — 145 ölçümlü high, OOF maske (ölçülen n = 144):** MAE 0.84 mm, RMSE 1.00, r 0.875, ICC(2,1) 0.784 [0.288, 0.909]; sapma +0.68 mm, LoA -0.75…2.11; sınıf uyumu 62 %, doğrusal ağırlıklı κ 0.59 [0.50, 0.68].
  - Aynı yöntem GT maskede (Aşama 3): MAE 0.55, sapma +0.15 → segmentasyonun eklediği: MAE +0.29 mm, sapma +0.53 mm (alt dişeti kenarı GT'den 0.66 mm aşağıda çiziliyor; üst kenar +0.16 mm).
...
- **İkincil (b) — test high 29 görüntü, final model:** MAE 0.95 mm, r 0.804, ICC 0.731, sapma +0.65; κ 0.40 [0.20, 0.59] (n küçük, GA geniş). Düzeltilmiş: MAE 0.47, sapma -0.10, κ 0.64.
...
- Diş düzeyi karma model (hasta rastgele kesişim): sapma +0.68 mm [+0.56, +0.80].
