...
- OOF kontrolü: 145/145 görüntü, hepsi `yolo:masks.data`, fold başına [29, 29, 29, 29, 29]; boş tahmin: IMG_7289_jpg.
- Yöntem ve ölçek sabit (Aşama 3, GT maske): **C_p25**, **16.84 px/mm**; tahmin maskelerinde yeniden seçim/yeniden uydurma yapılmadı.
- **Birincil (a) — 145 ölçümlü high, OOF maske:** MAE 0.84 mm, RMSE 1.00, r 0.875, ICC(2,1) 0.784 [0.288, 0.909]; sapma +0.68 mm, LoA -0.75…2.12; sınıf uyumu 62 %, doğrusal ağırlıklı κ 0.59 [0.50, 0.68].
...
- **İkincil (b) — test high 29 görüntü, final model:** MAE 0.95 mm, r 0.804, ICC 0.731, sapma +0.65; κ 0.40 [0.20, 0.59] (n küçük, GA geniş).
...
- Sapmalar: `SAPMALAR.md` (3 madde; test_metrics.json içinde per_class bloğu yok — iş istasyonunda evaluate_test yeniden çalıştırılmalı).
