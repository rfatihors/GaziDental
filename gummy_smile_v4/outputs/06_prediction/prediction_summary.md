...
### Secondary — same set, corrected (offset_px -13 (-0.77 mm at 16.84 px/mm), secondary)
n = 144: MAE 0.494 mm, RMSE 0.733 mm, r 0.875, ICC(2,1) 0.871 [0.825, 0.906], bias -0.088 mm [-0.208, +0.033], LoA -1.52 to 1.34 mm, proportional-bias slope -0.085 (p = 0.052); within 0.5 mm 67 %, within 1 mm 90 %; label agreement 79.9 %, linear-weighted κ 0.743 [0.651, 0.818]. Clipped to 0 mm: 0.
Stage-3 holdout only, corrected: n = 57: MAE 0.461 mm, RMSE 0.635 mm, r 0.894, ICC(2,1) 0.891 [0.823, 0.934], bias -0.102 mm [-0.270, +0.066], LoA -1.34 to 1.14 mm, proportional-bias slope +0.071 (p = 0.269); within 0.5 mm 67 %, within 1 mm 93 %; label agreement 82.5 %, linear-weighted κ 0.794 [0.682, 0.898].
...
Corrected (offset_px -13 (-0.77 mm at 16.84 px/mm), secondary): n = 29: MAE 0.491 mm, RMSE 0.908 mm, r 0.804, ICC(2,1) 0.801 [0.621, 0.901], bias -0.125 mm [-0.473, +0.223], LoA -1.92 to 1.67 mm, proportional-bias slope -0.129 (p = 0.315); within 0.5 mm 79 %, within 1 mm 90 %; label agreement 75.9 %, linear-weighted κ 0.640 [0.373, 0.857]. Clipped: 0.
...
| (a) OOF masks, all reference images [PRIMARY] — corrected | offset_px -13 (-0.77 mm at 16.84 px/mm), secondary | 144 | 0.494 | 0.733 | 0.875 | 0.871 | 0.825 | 0.906 | -0.088 | -1.518 | 1.343 | -0.085 | 0.052 | 0.799 | 0.743 |
...
| (a) OOF, Stage-3 holdout images only (scale never fitted on these) — corrected | offset_px -13 (-0.77 mm at 16.84 px/mm), secondary | 57 | 0.461 | 0.635 | 0.894 | 0.891 | 0.823 | 0.934 | -0.102 | -1.340 | 1.137 | 0.071 | 0.269 | 0.825 | 0.794 |
...
| (a) OOF, Stage-3 dev images only — corrected | offset_px -13 (-0.77 mm at 16.84 px/mm), secondary | 87 | 0.515 | 0.790 | 0.872 | 0.861 | 0.795 | 0.907 | -0.078 | -1.629 | 1.472 | -0.171 | 0.003 | 0.782 | 0.711 |
| (a) OOF, main-split train | none, PRIMARY | 87 | 0.790 | 0.907 | 0.910 | 0.817 | 0.216 | 0.933 | 0.667 | -0.544 | 1.878 | -0.097 | 0.043 | 0.667 | 0.671 |
| (a) OOF, main-split train — corrected | offset_px -13 (-0.77 mm at 16.84 px/mm), secondary | 87 | 0.445 | 0.623 | 0.910 | 0.905 | 0.857 | 0.937 | -0.105 | -1.316 | 1.106 | -0.097 | 0.043 | 0.839 | 0.802 |
| (a) OOF, main-split valid | none, PRIMARY | 28 | 0.907 | 1.139 | 0.854 | 0.754 | 0.178 | 0.911 | 0.800 | -0.819 | 2.418 | -0.027 | 0.809 | 0.536 | 0.458 |
| (a) OOF, main-split valid — corrected | offset_px -13 (-0.77 mm at 16.84 px/mm), secondary | 28 | 0.605 | 0.811 | 0.854 | 0.858 | 0.716 | 0.932 | 0.028 | -1.591 | 1.646 | -0.027 | 0.809 | 0.750 | 0.702 |
...
| (b') OOF masks on the test high images (fold models) — corrected | offset_px -13 (-0.77 mm at 16.84 px/mm), secondary | 29 | 0.533 | 0.930 | 0.798 | 0.796 | 0.612 | 0.898 | -0.146 | -1.977 | 1.685 | -0.106 | 0.415 | 0.724 | 0.609 |
...
| (a) sensitivity: without dash-zero reference rows — corrected | offset_px -13 (-0.77 mm at 16.84 px/mm), secondary | 111 | 0.480 | 0.733 | 0.864 | 0.858 | 0.798 | 0.901 | -0.152 | -1.564 | 1.260 | -0.073 | 0.160 | 0.793 | 0.754 |
...
| (a) sensitivity: only 2698x1799 (±2 px) frames — corrected | offset_px -13 (-0.77 mm at 16.84 px/mm), secondary | 123 | 0.484 | 0.714 | 0.889 | 0.885 | 0.840 | 0.918 | -0.107 | -1.496 | 1.281 | -0.069 | 0.121 | 0.797 | 0.747 |
...
| (a) sensitivity: without zenith-fallback images — corrected | offset_px -13 (-0.77 mm at 16.84 px/mm), secondary | 119 | 0.463 | 0.732 | 0.865 | 0.859 | 0.803 | 0.900 | -0.140 | -1.554 | 1.273 | -0.086 | 0.086 | 0.807 | 0.751 |
...
| (a) sensitivity: without empty predictions — corrected | offset_px -13 (-0.77 mm at 16.84 px/mm), secondary | 144 | 0.494 | 0.733 | 0.875 | 0.871 | 0.825 | 0.906 | -0.088 | -1.518 | 1.343 | -0.085 | 0.052 | 0.799 | 0.743 |
...
| (b) final model masks, test high images [secondary set] — corrected | offset_px -13 (-0.77 mm at 16.84 px/mm), secondary | 29 | 0.491 | 0.908 | 0.804 | 0.801 | 0.621 | 0.901 | -0.125 | -1.919 | 1.668 | -0.129 | 0.315 | 0.759 | 0.640 |
